...
export class AdminApiRoyaltyApiClient {
     ...
     * @param pagedIndex (optional) 
     * @param pagedSize (optional) 
     * @return Success
     */
    getTransactionHistory(keyword?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined, pagedIndex?: number | undefined, pagedSize?: number | undefined): Observable<TransactionDtoPagedResult> {
        ...
        if (pagedIndex === null)
            throw new Error("The parameter 'pagedIndex' cannot be null.");
        else if (pagedIndex !== undefined)
            url_ += "pagedIndex=" + encodeURIComponent("" + pagedIndex) + "&";
        if (pagedSize === null)
            throw new Error("The parameter 'pagedSize' cannot be null.");
        else if (pagedSize !== undefined)
            url_ += "pagedSize=" + encodeURIComponent("" + pagedSize) + "&";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getRoyaltyReportByUser(userId?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined): Observable<RoyaltyReportByUserDtoPagedResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<RoyaltyReportByUserDtoPagedResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RoyaltyReportByUserDtoPagedResult>;
        }));
    }

    protected processGetRoyaltyReportByUser(response: HttpResponseBase): Observable<RoyaltyReportByUserDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RoyaltyReportByUserDtoPagedResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getRoyaltyReportByMonth(userId?: string | null | undefined, fromMonth?: number | undefined, fromYear?: number | undefined, toMonth?: number | undefined, toYear?: number | undefined): Observable<RoyaltyReportByMonthDtoPagedResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<RoyaltyReportByMonthDtoPagedResult>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RoyaltyReportByMonthDtoPagedResult>;
        }));
    }

    protected processGetRoyaltyReportByMonth(response: HttpResponseBase): Observable<RoyaltyReportByMonthDtoPagedResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RoyaltyReportByMonthDtoPagedResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class RoyaltyReportByMonthDtoPagedResult implements IRoyaltyReportByMonthDtoPagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    readonly lastRowOnPage?: number;
    additionalData?: string | undefined;
    results?: RoyaltyReportByMonthDto[] | undefined;

    constructor(data?: IRoyaltyReportByMonthDtoPagedResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(RoyaltyReportByMonthDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): RoyaltyReportByMonthDtoPagedResult {
        data = typeof data === 'object' ? data : {};
        let result = new RoyaltyReportByMonthDtoPagedResult();
        result.init(data);
        return result;
    }
...
export interface IRoyaltyReportByMonthDtoPagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
...
export class RoyaltyReportByUserDtoPagedResult implements IRoyaltyReportByUserDtoPagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    readonly lastRowOnPage?: number;
    additionalData?: string | undefined;
    results?: RoyaltyReportByUserDto[] | undefined;

    constructor(data?: IRoyaltyReportByUserDtoPagedResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(RoyaltyReportByUserDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): RoyaltyReportByUserDtoPagedResult {
        data = typeof data === 'object' ? data : {};
        let result = new RoyaltyReportByUserDtoPagedResult();
        result.init(data);
        return result;
    }
...
export interface IRoyaltyReportByUserDtoPagedResult {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
